...
C assign growth functions Lambda
        ...
        ! 1/4 flower
        EE = (Pi**2*(200+Y*(800+800*Y+401*Y**3)+40*Y**2*(1+2*Y)*Cos(10*Pi*X)-399*Y**4*Cos(20*Pi*X)))/6400
        FF = -(1.0/40)*Pi*Y**2*(10+Y*Cos(10*Pi*X))*Sin(10*Pi*X)
        GG = 1.0/200*(10+Y*Cos(10*Pi*X))**2
        LL = 0.0
        MM = 0.0
        NN = 0.0
